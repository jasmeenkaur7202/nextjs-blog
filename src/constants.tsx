...
export const ABOUT_TEXT = `Welcome to our About page! Here, we'd like to tell you a little bit about who we are and what we do. Our journey began with a simple idea: to create a platform where people can share their thoughts, stories, and experiences with the world. We believe that everyone has a unique voice and perspective to offer, and we're here to provide a space for you to express yourself freely.
